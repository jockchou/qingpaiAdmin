...
$db['default']['hostname'] = '192.168.200.2';
...
$db['pingo_ms']['hostname'] = '192.168.200.2';
...
$db['pingo_ms']['pconnect'] = FALSE;
$db['pingo_ms']['db_debug'] = TRUE;
$db['pingo_ms']['cache_on'] = FALSE;
...
$db['joyo_admin']['hostname'] = '121.201.7.119';
...
$db['pingo_analysis']['hostname'] = '121.201.7.119';
