...
class CI_Upload {
	...
	public $client_name				= '';
	public $bucket 					= "pingodata";
	public $fileMD5					= '';
	
	public $qiniuData				= array();
	...
	public function initialize($config = array())
	{
		$defaults = array(
							...
							'file_size'			=> "",
							'file_ext'			=> "",
							'upload_path'		=> JY_UPLOAD_IMG_PATH,
							'overwrite'			=> FALSE,
							'encrypt_name'		=> FALSE,
							'is_image'			=> FALSE,
							'image_width'		=> '',
	...
	public function data()
	{
		...
		$file_path = $this->upload_path . $profix . "/";
		$full_path = $file_path.$this->file_name;
		return array (
	...
	public function set_filename($path, $filename)
	{
		...
		{
			//mt_srand();
			$filename = $this->fileMD5. strtolower($this->file_ext);
		}
